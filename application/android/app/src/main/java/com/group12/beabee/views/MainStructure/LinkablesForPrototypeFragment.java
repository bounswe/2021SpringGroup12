...
public class LinkablesForPrototypeFragment extends Fragment implements IOnTaskClickedListener,
    ...
    public LinkablesForPrototypeFragment(int id, BaseEntityLinkableFragment parentFragment, ParentType parentType){
        this.id = id;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_prototype_linkables, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        /*BeABeeService.serviceAPI.getProEntity(BeABeeApplication.currentPrototypeGoal).enqueue(new Callback<List<EntityShort>>() {
            @Override
