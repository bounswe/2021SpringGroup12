...
import random
from helpers import issue_helper, books_helper, name_info_helper, anime_helper, currency_helper, quote_helper, cocktail_helper
...
DB_PATH = "practice-app/sqlfiles/practice-app.db"
...
def get_cocktails():
    ...
    r = requests.get(
        "http://www.thecocktaildb.com/api/json/v1/1/search.php?s={}".format(cocktail_name))
    r = r.json()
